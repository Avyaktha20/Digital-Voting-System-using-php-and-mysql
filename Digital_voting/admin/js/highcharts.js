...
(function () {
  ...
  function Pb(a, b, c, d) {
    ...
    b >= D[hb] &&
      (i.setMilliseconds(0),
      i.setSeconds(b >= D[Ya] ? 0 : j * W(i.getSeconds() / j)));
    ...
    for (
      ...
      e.push(k),
        b === D[ta]
          ...
          ? (k = bb(h, l + d * j))
          : !g && (b === D[oa] || b === D[Za])
          ? (k = bb(h, l, m + d * j * (b === D[oa] ? 1 : 7)))
          : ((k += b * j), b <= D[Ma] && k % D[oa] === i && (f[k] = oa)),
        d++;
    e.push(k);
  ...
  function pb(a, b) {
    ...
    this.label = a.renderer
      .label("", 0, 0, null, null, null, b.useHTML, null, "tooltip")
      .attr({
        padding: f,
  ...
  var A,
    ...
    La = /msie/i.test(ya) && !N.opera,
    Ca = B.documentMode === 8,
    Fb = /AppleWebKit/.test(ya),
    Gb = /Firefox/.test(ya),
    Da =
      !!B.createElementNS &&
      !!B.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect,
    Rb = Gb && parseInt(ya.split("Firefox/")[1], 10) < 4,
    ga = !Da && !La && !!B.createElement("canvas").getContext,
    Ta,
    ea = B.documentElement.ontouchstart !== A,
    Hb = {},
    sb = 0,
    cb,
    V,
    ...
    ia = "div",
    U = "none",
    tb = "rgba(192,192,192," + (Da ? 1.0e-6 : 0.002) + ")",
    vb = "millisecond",
    hb = "second",
    Ya = "minute",
    Ma = "hour",
  ...
  if (!T && N.jQuery) {
    ...
    n(["cur", "_default", "width", "height"], function (a, b) {
      ...
      a === "cur"
        ...
        : a === "_default" &&
          Q.Tween &&
          ((c = Q.Tween.propHooks[a]), (a = "set"));
      (d = c[a]) &&
        (c[a] = function (c) {
          c = b ? c : this;
          e = c.elem;
          return e.attr
            ? e.attr(c.prop, a === "cur" ? A : c.now)
  ...
  V = {
    colors:
      "#4572A7,#AA4643,#89A54E,#80699B,#3D96AE,#DB843D,#92A8CD,#A47D7C,#B5CA92".split(
        ","
      ),
    ...
    global: {
      useUTC: !0,
      canvasToolsURL:
        "http://code.highcharts.com/2.2.5/modules/canvas-tools.js",
    },
    chart: {
      borderColor: "#4572A7",
      borderRadius: 5,
  ...
  va.prototype = {
    init: function (a, b) {
      this.element =
        b === "span"
          ? S(b)
          : B.createElementNS("http://www.w3.org/2000/svg", b);
      this.renderer = a;
      this.attrSetters = {};
    },
    ...
    attr: function (a, b) {
            ...
            if (l && /^(width|height|visibility|x|y|d|transform)$/.test(c))
              for (e = l.length; e--; )
                z(
                  l[e],
                  c,
                  c === "height" ? x(d - (l[e].cutHeight || 0), 0) : d
                );
      ...
      if (
        Fb &&
        /Chrome\/(18|19)/.test(ya) &&
        h === "text" &&
        (a.x !== A || a.y !== A)
      )
        (c = g.parentNode),
          (d = g.nextSibling),
          c && (c.removeChild(g), d ? c.insertBefore(g, d) : c.appendChild(g));
      return q;
    },
    ...
    css: function (a) {
      ...
      if (La && !Da) b && delete a.width, F(this.element, a);
      else {
    ...
    htmlUpdateTransform: function () {
      if (this.added) {
        ...
        if (b.tagName === "SPAN") {
          ...
          var r = this.xCorr || 0,
            y = this.yCorr || 0,
            $ = [j, g, b.innerHTML, this.textWidth].join(",");
          if ($ !== this.cTT)
            s(j) &&
              ((k = j * Eb),
              (p = X(k)),
    ...
    getBBox: function (a) {
      ...
      if (
        ...
        c = b.height;
        if (d)
          (b.width = M(c * da(e)) + M(a * X(e))),
            (b.height = M(c * X(e)) + M(a * da(e)));
  ...
  qa.prototype = {
    ...
    buildText: function (a) {
      ...
      n(c, function (c, d) {
        ...
        n(h, function (c) {
          if (c !== "" || h.length === 1) {
            var m = {},
              n = B.createElementNS("http://www.w3.org/2000/svg", "tspan");
            e.test(c) &&
              z(
                n,
                "style",
                c.match(e)[1].replace(/(;| |^)color([ :])/, "$1fill$2")
              );
            f.test(c) &&
              (z(n, "onclick", 'location.href="' + c.match(f)[1] + '"'),
              F(n, { cursor: "pointer" }));
            c = (c.replace(/<(.|\n)*?>/g, "") || " ")
              .replace(/&lt;/g, "<")
              .replace(/&gt;/g, ">");
            ...
            if (!fa) {
              if (d) {
                ...
                r =
                  N.getComputedStyle &&
                  w(
                    N.getComputedStyle(k, null).getPropertyValue("line-height")
                  );
                if (!r || isNaN(r)) {
                  var o;
                  if (!(o = j))
                    if (!(o = k.offsetHeight))
                      (l[d] = b.getBBox().height),
                        (o = t(l[d] - (l[d - 1] || 0)) || 18);
                  r = o;
                }
                z(n, "dy", r);
                  ...
                  !m || c.length === 1
                    ? ((c = H),
                      ...
                      c.length &&
                        ...
                        b.appendChild(n),
                        o > i && (i = o)))
                    : (n.removeChild(n.firstChild), H.unshift(c.pop())),
                  c.length &&
                    n.appendChild(
                      B.createTextNode(c.join(" ").replace(/- /g, "-"))
                    );
          }
        });
      });
    ...
    symbol: function (a, b, c, d, e, f) {
      ...
      h
        ? ((g = this.path(h)),
          u(g, { symbolName: a, x: b, y: c, width: d, height: e }),
          f && u(g, f))
        : i.test(a) &&
          ((k = function (a, b) {
    ...
    color: function (a, b, c) {
      ...
      if (g) {
        ...
        if (!c.id || !h[c.id])
          Ja(c) &&
            ...
            n(a.stops, function (a) {
              f.test(a[1])
                ? ((e = pa(a[1])), (j = e.get("rgb")), (k = e.get("a")))
                : ((j = a[1]), (k = 1));
              a = d
                .createElement("stop")
                .attr({ offset: a[0], "stop-color": j, "stop-opacity": k })
                .add(i);
              i.stops.push(a);
            });
        ...
        return f.test(a)
          ? ((e = pa(a)), z(b, c + "-opacity", e.get("a")), e.get("rgb"))
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
      ...
      var m = this,
        p = m.g(i),
        q = m.text("", 0, 0, g).attr({ zIndex: 1 }).add(p),
        o,
        r,
        y = 0,
        $ = 3,
          ...
          (c = h ? -Ha : 0),
            (p.box = o =
              d
                ...
                : m.rect(-y * $, c, p.width, p.height, 0, x["stroke-width"])),
            o.add(p);
  ...
  if (!Da && !ga) {
    ...
    var ha = {
      ...
      color: function (a, b, c) {
        ...
        a && a.linearGradient
          ? (f = "gradient")
          : a && a.radialGradient && (f = "pattern");
        if (f) {
          var h,
            i,
            j = a.linearGradient || a.radialGradient,
            k,
            l,
            m,
            p,
          ...
          n(a, function (a, b) {
            e.test(a[1])
              ? ((d = pa(a[1])), (h = d.get("rgb")), (i = d.get("a")))
              : ((h = a[1]), (i = 1));
            s.push(a[0] * 100 + "% " + h);
            b ? ((p = i), (q = h)) : ((m = i), (o = h));
          });
          f === "gradient"
            ? ((k = j.x1 || j[0] || 0),
              ...
              (l = j.x2 || j[2] || 0),
              (j = j.y2 || j[3] || 0),
              (k = 90 - (L.atan((j - a) / (l - k)) * 180) / xa))
            : ((g = j.r * 2),
              (r =
                'src="http://code.highcharts.com/gfx/radial-gradient.png" size="' +
                g +
                "," +
                g +
      ...
      symbols: {
        arc: function (a, b, c, d, e) {
          var f = e.start,
            ...
            m = (k && 0.1 / k) || 0;
          if (g - f === 0) return ["x"];
          else 2 * xa - g + f < l ? (i = -l) : g - f < m && (i = X(f + m));
          f = [
            "wa",
            a - h,
            b - h,
        ...
        rect: function (a, b, c, d, e) {
          var f = a + c,
            ...
            h;
          !s(e) || !e.r
            ? (f = qa.prototype.symbols.square.apply(0, arguments))
            : ((h = O(e.r, c, d)),
              (f = [
                "M",
                a + h,
  ...
  Sa.prototype = {
    addLabel: function () {
      ...
      b = a.labelFormatter.call({
        ...
        value: a.isLog ? ja(ba(k)) : k,
      });
      f = d && { width: x(1, t(d - 2 * (g.padding || 10))) + "px" };
      f = u(f, g.style);
      if (s(e)) e && e.attr({ text: b }).css(f);
      else {
        d = { align: g.align };
    ...
    getLabelSize: function () {
      var a = this.label,
        b = this.axis;
      return a
        ? (this.labelBBox = a.getBBox(!0))[b.horiz ? "height" : "width"]
        : 0;
    },
    ...
    render: function (a, b) {
      var c = this.axis,
        ...
        t = j.step,
        v = !0,
        H = d.categories && d.tickmarkPlacement === "between" ? 0.5 : 0,
        J = this.getPosition(f, i, H, b),
        K = J.x,
        J = J.y,
        x = c.staggerLines;
      if (p) {
      ...
      if (l)
        s === "inside" && (r = -r),
          c.opposite && (r = -r),
          (g = this.getMarkPath(K, J, r, l, f, e)),
          m
            ? m.animate({ d: g })
            : (this.mark = e
                .path(g)
                .attr({ stroke: y, "stroke-width": l })
                .add(c.axisGroup));
      if (h && !isNaN(K))
        (h.xy = J = this.getLabelPosition(K, J, h, f, j, H, a, t)),
          ...
          (this.isLast && !o(d.showLastLabel, 1))
            ...
            : !x &&
              f &&
              j.overflow === "justify" &&
              !this.handleOverflow(a, J) &&
              (v = !1),
          t && a % t && (v = !1),
          v
            ? (h[this.isNew ? "attr" : "animate"](J),
              h.show(),
              (this.isNew = !1))
            : h.hide();
    },
  ...
  Cb.prototype = {
    ...
    setOffset: function (a, b) {
      ...
      this.label &&
        this.label
          .align(this.alignOptions, null, e)
  ...
  ob.prototype = {
        ...
        if (g.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            if (((h = g.xData), h.length))
              (a.dataMin = O(o(a.dataMin, h[0]), Pa(h))),
                ...
                r !== null &&
                  ...
                  (i
                    ? ((J = (H = r < y) ? k : j),
                      ...
                      c[K] || (c[K] = {}),
                      c[K][n] ||
                        (c[K][n] = new Cb(a, a.options.stackLabels, H, n, m)),
                      c[K][n].setTotal(r))
                    : w && (r = g.modifyValue(r)),
                  C ||
                    ((h[f + 1] || n) >= Ha.min && (h[f - 1] || n) <= Ha.max)))
              )
                if ((n = r.length))
                  for (; n--; ) r[n] !== null && (u[v++] = r[n]);
                else u[v++] = r;
            if (!a.usePercentage && u.length)
              (a.dataMin = O(o(a.dataMin, u[0]), Pa(u))),
                (a.dataMax = x(o(a.dataMax, u[0]), Aa(u)));
            if (s(y))
    ...
    translate: function (a, b, c, d, e) {
      ...
      b
        ? (this.reversed && (a = f - a),
          ...
          e && (a = this.lin2val(a)))
        : (e && (a = this.val2lin(a)),
          (a = g * (a - d) * i + h + g * this.minPixelPadding));
      return a;
    },
    ...
    getLinearTickPositions: function (a, b, c) {
      for (
        var d, b = ja(W(b / a) * a), c = ja(wa(c / a) * a), e = [];
        b <= c;
    ...
    getLogTickPositions: function (a, b, c, d) {
      ...
      if (a >= 0.5) (a = t(a)), (g = this.getLinearTickPositions(a, b, c));
        ...
        (a = gb(a, null, L.pow(10, W(L.log(a) / L.LN10)))),
        (g = Ea(this.getLinearTickPositions(a, b, c), ma)),
        !d)
      )
    ...
    setAxisTranslation: function () {
      ...
      if (this.isXAxis)
        this.isLinked
          ? (b = this.linkedParent.pointRange)
          : n(this.series, function (a) {
              b = x(b, a.pointRange);
    ...
    setTickPositions: function (a) {
      ...
      h
        ? ((b.linkedParent = c[g ? "xAxis" : "yAxis"][d.linkedTo]),
          ...
          d.type !== b.linkedParent.options.type && mb(11, 1))
        : ((b.min = o(b.userMin, d.min, b.dataMin)),
          (b.max = o(b.userMax, d.max, b.dataMax)));
      if (e)
        !a && O(b.min, o(b.dataMin, b.min)) <= 0 && mb(10, 1),
          (b.min = ja(ma(b.min))),
          (b.max = ja(ma(b.max)));
      if (
        b.range &&
        ((b.userMin = b.min = x(b.min, b.max - b.range)),
        (b.userMax = b.max),
        a)
      )
        b.range = null;
      ...
      b.tickInterval =
        b.min === b.max || b.min === void 0 || b.max === void 0
          ? 1
          : h && !l && m === b.linkedParent.options.tickPixelInterval
          ? b.linkedParent.tickInterval
          : o(l, p ? 1 : ((b.max - b.min) * m) / (b.len || 1));
      g &&
        !a &&
      ...
      if (
        !f &&
        !e &&
        ((a = L.pow(10, W(L.log(b.tickInterval) / L.LN10))), !s(d.tickInterval))
      )
      ...
      if (!i)
        (i = f
          ? (b.getNonLinearTimeTicks || Pb)(
              Ob(b.tickInterval, d.units),
              b.min,
              b.max,
              d.startOfWeek,
              b.ordinalPositions,
      ...
      if (!h)
        (e = i[0]),
          (f = i[i.length - 1]),
          d.startOnTick ? (b.min = e) : b.min > e && i.shift(),
          d.endOnTick ? (b.max = f) : b.max < f && i.pop();
    },
    ...
    getExtremes: function () {
      var a = this.isLog;
      return {
        min: a ? ja(ba(this.min)) : this.min,
        max: a ? ja(ba(this.max)) : this.max,
        ...
        if (!a.axisTitle)
          (a.axisTitle = c
            ...
            .attr({
              ...
              align:
                m.textAlign ||
                { low: "left", middle: "center", high: "right" }[m.align],
            })
            .css(m.style)
            .add(a.axisGroup)),
            (a.axisTitle.isNew = !0);
    ...
    render: function () {
      var a = this,
        ...
        q = d.lineWidth,
        o,
        r = b.hasRendered && s(a.oldMin) && !isNaN(a.oldMin),
        y = a.showAxis,
        t,
        u;
      if (a.hasData || f)
      ...
      if (q)
        (o = a.getLinePath(q)),
          a.axisLine
            ? a.axisLine.animate({ d: o })
            : (a.axisLine = c
                .path(o)
                .attr({ stroke: d.lineColor, "stroke-width": q, zIndex: 7 })
                .add()),
    ...
    destroy: function () {
      ...
      n(
        ["stackTotalGroup", "axisLine", "axisGroup", "gridGroup", "axisTitle"],
        function (b) {
          a[b] && (a[b] = a[b].destroy());
        }
      );
  ...
  pb.prototype = {
    ...
    move: function (a, b) {
      ...
      c.tooltipTick =
        M(a - c.currentX) > 1 || M(b - c.currentY) > 1
          ? function () {
              c.move(a, b);
            }
          : null;
    ...
    refresh: function (a, b) {
        ...
        n(a, function (a) {
          ...
          c.push(
            (b.tooltipFormatter && b.tooltipFormatter(a)) ||
              a.point.tooltipFormatter(b.tooltipOptions.pointFormat)
          );
        });
      ...
      k === !1 || !i
        ...
        : (this.tooltipIsHidden && e.show(),
          ...
          this.move(t(e.x), t(e.y)),
          (this.tooltipIsHidden = !1));
      if (p) {
        p = na(p);
        for (e = p.length; e--; )
          if (((i = a.series[e ? "yAxis" : "xAxis"]), p[e] && i))
            if (
              ((i = i.getPlotLinePath(e ? o(a.stackY, a.y) : a.x, 1)),
              this.crosshairs[e])
            )
  ...
  Db.prototype = {
      ...
      n(c.axes, function (d) {
        ...
        b[e ? "xAxis" : "yAxis"].push({
          ...
          value: d.translate(
            (c.inverted ? !e : e)
              ? a.chartX - c.plotLeft
              : c.plotHeight - a.chartY + c.plotTop,
            !0
          ),
        });
      });
    ...
    setDOMEvents: function () {
      ...
      var h = function (a) {
        if (!a || !(a.touches && a.touches.length > 1)) {
          ...
          if (l)
            d < c.plotLeft
              ? (d = c.plotLeft)
              : d > c.plotLeft + c.plotWidth && (d = c.plotLeft + c.plotWidth),
              h < c.plotTop
                ? (h = c.plotTop)
          ...
          if (c.mouseIsDown && a.type !== "touchstart") {
            if (
              ((e = Math.sqrt(
                Math.pow(b.mouseDownX - d, 2) + Math.pow(b.mouseDownY - h, 2)
              )),
              e > 10)
            ) {
              a = c.isInsidePlot(
      ...
      d.onclick = function (a) {
        ...
        a.cancelBubble = !0;
        if (!c.cancelClick)
          d && (z(a.target, "isTracker") || z(a.target.parentNode, "isTracker"))
            ? ((e = d.plotX),
              (f = d.plotY),
              u(d, {
                pageX:
              ...
              E(d.series, "click", u(a, { point: d })),
              d.firePointEvent("click", a))
            : (u(a, b.getMouseCoordinates(a)),
  ...
  qb.prototype = {
    ...
    renderItem: function (a) {
      ...
      d = r.getBBox();
      (q = a.legendItemWidth =
        e.itemWidth || g + h + d.width + k + (u ? 20 : 0)),
        (e = q);
      b.itemHeight = g = d.height;
      if (f && b.itemX - o + e > (m || c.chartWidth - 2 * k - o))
        (b.itemX = o),
          (b.itemY += n + b.lastLineHeight + p),
          (b.lastLineHeight = 0);
    ...
    scroll: function (a, b) {
      ...
      if (d > 0)
        b !== A && ua(b, this.chart),
          ...
          this.down
            .attr({ x: 18 + this.pager.getBBox().width, fill: d === c ? f : g })
  ...
  rb.prototype = {
    initSeries: function (a) {
      var b = this.options.chart,
        b = new Y[a.type || b.type || b.defaultSeriesType]();
      b.init(this, a);
      return b;
    },
    addSeries: function (a, b, c) {
      ...
      a &&
        (ua(c, d),
        (b = o(b, !0)),
        E(d, "addSeries", { options: a }, function () {
          d.initSeries(a);
          d.isDirtyLegend = !0;
          b && d.redraw();
        }));
    ...
    redraw: function (a) {
      ...
      if (g)
        for (j = i; j--; ) if (((a = c[j]), a.options.stacking)) a.isDirty = !0;
      n(c, function (a) {
      ...
      h &&
        ...
        k &&
          (Fa(k),
          k.animate({ width: this.plotSizeX, height: this.plotSizeY + 1 })));
      n(c, function (a) {
    ...
    zoom: function (a) {
      ...
      !a || a.resetSelection
        ? n(b.axes, function (a) {
            a.options.zoomEnabled !== !1 &&
              (a.setExtremes(null, null, !1), (d = !0));
          })
    ...
    getChartSize: function () {
      ...
      this.chartHeight =
        a.height || (this.containerHeight > 19 ? this.containerHeight : 400);
    },
    cloneRenderTo: function (a) {
      var b = this.renderToClone,
        c = this.container;
      a
        ? b && (this.renderTo.appendChild(c), Qa(b), delete this.renderToClone)
        : (c && this.renderTo.removeChild(c),
          (this.renderToClone = b = this.renderTo.cloneNode(0)),
          F(b, { position: "absolute", top: "-9999px", display: "block" }),
    ...
    getMargins: function () {
      ...
      if ((this.title || this.subtitle) && !s(this.optionsMarginTop))
        if (
          (l = x(
            (this.title && !k.floating && !k.verticalAlign && k.y) || 0,
            (this.subtitle && !l.floating && !l.verticalAlign && l.y) || 0
          ))
        )
    ...
    initReflow: function () {
      function a(a) {
        var g = c.width || Va(d, "width"),
          h = c.height || Va(d, "height"),
          a = a ? a.target : N;
        if (g && h && (a === N || a === B)) {
    ...
    resize: function (a, b, c) {
      ...
      Ra === !1
        ? this.fireEndResize()
        : setTimeout(this.fireEndResize, (Ra && Ra.duration) || 500);
    },
      ...
      if (i || j)
        if (e) e.animate(e.crisp(null, null, null, c - m, d - m));
          ...
          this.chartBackground = b
            .rect(m / 2, m / 2, c - m, d - m, a.borderRadius, i)
            .attr(e)
            .add()
            .shadow(a.shadow);
        }
    ...
    render: function () {
      ...
      e.items &&
        n(e.items, function () {
          var b = u(e.style, this.style),
            d = w(b.left) + a.plotLeft,
            f = w(b.top) + a.plotTop + 12;
          delete b.left;
          delete b.top;
    ...
    firstRender: function () {
      var a = this,
        ...
        c = a.callback;
      if (
        (!Da && N == N.top && B.readyState !== "complete") ||
        (ga && !N.canvg)
      )
        ga
          ? Nb.push(function () {
  ...
  R.prototype = {
    ...
    setData: function (a, b) {
      ...
      if (l > (d.turboThreshold || 1e3)) {
        ...
        if (Ka(g)) {
          ...
          else for (e = 0; e < l; e++) (d = a[e]), (j[e] = d[0]), (k[e] = d[1]);
      } else
        for (e = 0; e < l; e++)
          (d = { series: this }),
            i.applyOptions.apply(d, [a[e]]),
            (j[e] = d.x),
            (k[e] = i.toYData ? i.toYData.apply(d) : d.y);
      this.data = [];
      this.options.data = a;
      this.xData = j;
      this.yData = k;
    ...
    processData: function (a) {
      ...
      for (a = b.length - 1; a > 0; a--)
        if (((d = b[a] - b[a - 1]), d > 0 && (h === A || d < h))) h = d;
      this.cropped = g;
      this.cropStart = e;
      ...
      for (m = 0; m < g; m++)
        (i = h + m),
          j
            ...
            : (b[i]
                ? (k = b[i])
                : a[i] !== A && (b[i] = k = new f().init(this, a[i], d[m])),
              (l[m] = k));
      if (b && (g !== (c = b.length) || j))
        for (m = 0; m < c; m++)
          if ((m === h && !j && (m += g), b[m]))
    ...
    translate: function () {
      ...
      for (l = 0; l < h; l++) {
        var k = g[l],
          ...
          p = k.y,
          n = k.low,
          o = f.stacks[(p < b.threshold ? "-" : "") + this.stackKey];
        ...
        k.plotY =
          typeof p === "number" ? t(f.translate(p, 0, 1, 0, 1) * 10) / 10 : A;
      ...
      if (this.options.enableMouseTracking !== !1) {
        ...
        for (g = 0; g < a; g++) {
          ...
          for (
            f._high = e =
              b[g + 1]
                ? x(0, W((f.plotX + (b[g + 1] ? b[g + 1].plotX : c)) / 2))
                : c;
            d >= 0 && d <= e;
        ...
        for (f = b.length; f--; )
          if (
            ...
            if (
              ...
              (h = a.r),
              (i = o(g.marker && g.marker.symbol, this.symbol)),
              (j = i.indexOf("url") === 0),
              k)
            )
              k.animate(
    ...
    getAttribs: function () {
      var a = this,
        b = Z[a.type].marker ? a.options.marker : a.options,
        c = b.states,
        d = c.hover,
        e,
        f = a.color,
      ...
      for (f = h.length; f--; ) {
        ...
        if (e) {
          ...
          e = c.hover = c.hover || {};
          if (!a.options.marker)
            e.color = pa(e.color || g.options.color)
    ...
    destroy: function () {
      ...
      n(
        "area,graph,dataLabelsGroup,group,tracker,trackerGroup".split(","),
        function (b) {
    ...
    drawDataLabels: function () {
      ...
      if (c.enabled || a._hasPointLabels) {
        var d,
          ...
          r = b.stacking,
          y = u === "column" || u === "bar",
          x = c.verticalAlign === null,
          w = c.y === null,
          v = p.fontMetrics(c.style.fontSize),
          H = v.h,
          J = v.b,
          K,
          z;
        y &&
          ((v = { top: J, middle: J - H / 2, bottom: -H + J }),
          r
            ? (x && (c = C(c, { verticalAlign: "middle" })),
              w && (c = C(c, { y: v[c.verticalAlign] })))
            : x
            ? (c = C(c, { verticalAlign: "top" }))
            : w && (c = C(c, { y: v[c.verticalAlign] })));
        j
          ? j.translate(l, m)
          : (j = a.dataLabelsGroup =
        ...
        n(f, function (f) {
          ...
          if ((z = c.enabled)) {
            var l = (f.barX && f.barX + f.barW / 2) || o(f.plotX, -999),
              m = o(f.plotY, -999),
              n = c.y === null ? (f.y >= b.threshold ? -H + J : J) : c.y;
          ...
          if (K && a.isCartesian && (!k.isInsidePlot(d, e) || !z))
            ...
            if (K) K.attr({ text: i }).animate({ x: d, y: e });
              ...
              K = f.dataLabel = p[c.rotation ? "text" : "label"](
                i,
                d,
                e,
                null,
            ...
            if (y && b.stacking && K)
              (v = f.barX),
                ...
                (f = f.barH),
                K.align(c, null, {
                  x: q ? k.plotWidth - l - f : v,
                  y: q ? k.plotHeight - v - m : l,
                  width: q ? f : m,
                  height: q ? m : f,
                });
          }
    ...
    createGroup: function () {
      var a = this.chart;
      (this.group = a.renderer.g("series"))
        .attr({
    ...
    render: function () {
      ...
      if (
        ...
        ((g = a.clipRect =
          !b.hasRendered && b.clipRect
            ? b.clipRect
            : h.clipRect(0, 0, b.plotSizeX, b.plotSizeY + 1)),
        !b.clipRect)
      )
        b.clipRect = g;
      a.createGroup();
      ...
      e &&
        !a.hasRendered &&
        (c.clip(g), a.trackerGroup && a.trackerGroup.clip(b.clipRect));
      d && a.animate();
      setTimeout(function () {
        g.isAnimating = !1;
    ...
    setVisible: function (a, b) {
      ...
      if (f) f[h]();
        ...
        for (e = i.length; e--; ) if (((f = i[e]), f.tracker)) f.tracker[h]();
      if (g) g[h]();
    ...
    drawTrackerGroup: function () {
      ...
      if (this.isCartesian) {
        if (!a)
          this.trackerGroup = a = b.renderer
            .g()
    ...
    drawTracker: function () {
      ...
      if (e && !c)
        for (m = e + 1; m--; )
          d[m] === "M" && d.splice(m + 1, 0, d[m + 1] - h, d[m + 2], "L"),
            ((m && d[m] === "M") || m === e) &&
      ...
      i
        ...
        : (a.tracker = g
            ...
            .on(ea ? "touchstart" : "mouseover", function () {
  ...
  var Ia = G.prototype,
    ha = ca(ha, {
      type: "areaspline",
      getSegmentPath: Ia.getSegmentPath,
      drawGraph: Ia.drawGraph,
    });
  Y.areaspline = ha;
  Z.column = C(T, {
    borderColor: "#FFFFFF",
    ...
    translate: function () {
      ...
      n(b.series, function (b) {
        if (
          b.type === a.type &&
          b.visible &&
          a.options.group === b.options.group
        )
          b.options.stacking
            ? ((j = b.stackKey), i[j] === A && (i[j] = f++), (k = i[j]))
            : (k = f++),
            (b.columnIndex = k);
      });
      var l = a.points,
        g =
          M(g.transA) *
          (g.ordinalSlope || c.pointRange || g.closestPointRange || 1),
        m = g * c.groupPadding,
        p = (g - 2 * m) / f,
        q = c.pointWidth,
        t = s(q) ? (p - q) / 2 : p * c.pointPadding,
        r = o(q, p - 2 * t),
        y = wa(x(r, 1 + 2 * e)),
        w =
          t +
          (m + ((h ? f - a.columnIndex : a.columnIndex) || 0) * p - g / 2) *
            (h ? -1 : 1),
        z = a.yAxis.getThreshold(c.threshold),
        ...
        if (g !== A && !isNaN(g) && f.y !== null)
          (d = f.graphic),
            ...
            d
              ...
              : (f.graphic = d =
                  c[f.shapeType](e)
                    .attr(f.pointAttr[f.selected ? "select" : ""])
                    .add(a.group)
        ...
        if (h.y !== null && m)
          e
            ...
            : (h.tracker = c[h.shapeType](d)
                ...
                .on(ea ? "touchstart" : "mouseover", function (c) {
  ...
  Y.column = ha;
  Z.bar = C(Z.column, {
    dataLabels: { align: "left", x: 5, y: null, verticalAlign: "middle" },
  });
  ...
  Ia = ca(R, {
    ...
    drawTracker: function () {
      ...
      a._hasTracking
        ...
        : a.group
            .attr({ isTracker: !0 })
            .on(ea ? "touchstart" : "mouseover", function (b) {
              a.onMouseOver();
  ...
  T = {
    ...
    translate: function () {
      ...
      n(k, function (c) {
        ...
        j = (i + h) / 2;
        c.slicedTranslation = Ea(
          [X(j) * d + g.plotLeft, da(j) * d + g.plotTop],
          t
        );
        p = (X(j) * f[2]) / 2;
        o = (da(j) * f[2]) / 2;
        ...
        e
          ...
          : (j.graphic = e =
              c
                ...
                .attr(u(j.pointAttr[""], { "stroke-linejoin": "round" }))
                .add(j.group)
                .shadow(g, h));
      ...
      if (d.enabled) {
        ...
        for (
          a =
            q[0][0] &&
            q[0][0].dataLabel &&
            (q[0][0].dataLabel.getBBox().height || 21);
          x--;
          ...
          for (v = 0; v < A; v++) {
            ...
            if (j > 0) {
              if (
                ...
                (B = r.i),
                (r = r.y),
                (s > r && w[B + 1] !== null) || (s < r && w[B - 1] !== null))
              )
                r = s;
            } else r = s;
            s = d.justify
              ? k[0] + (x ? -1 : 1) * (l + j)
              : this.getX(B === 0 || B === w.length - 1 ? s : r, x);
            g.attr({ visibility: t, align: h[6] })[
              g.moved ? "animate" : "attr"
            ]({ x: s + d.x + ({ left: e, right: -e }[h[6]] || 0), y: r + d.y });
            g.moved = !0;
            if (p && f)
              (g = b.connector),
                (h = i
                ...
                g
                  ? (g.animate({ d: h }), g.attr("visibility", t))
                  : (b.connector = g =
                      this.chart.renderer
                        .path(h)
                        .attr({
