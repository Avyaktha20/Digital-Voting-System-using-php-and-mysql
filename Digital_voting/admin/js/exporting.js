...
(function () {
  ...
  n(y.prototype, {
    ...
    exportChart: function (a, b) {
      ...
      c = r(
        "form",
        { method: "post", action: a.url, enctype: "multipart/form-data" },
        { display: "none" },
        h.body
      );
    ...
    addButton: function (a) {
      ...
      e.enabled !== !1 &&
        ((o = d
          ...
          .align(e, !0)
          .attr(
            n({ fill: e.backgroundColor, "stroke-width": a, zIndex: 19 }, j)
          )
          .add()),
        (q = d
          .rect(0, 0, h, k, 0)
        ...
        (p = d
          .symbol(e.symbol, e.symbolX - m / 2, e.symbolY - m / 2, m, m)
          .align(e, !0)
          .attr(n(l, { "stroke-width": e.symbolStrokeWidth || 1, zIndex: 20 }))
          .add()),
